...
void Controller::executeCommand(std::string command)
{
   ...
   else if (command.substr(0, 5) == "DH660")
   {
      ...
      else if (command.substr(5) == "DH660MUTE-------") m_ir.sendIr("dh_660hd", "KEY_MUTE");
      else if (command.substr(5) == "DH660LIST-------") m_ir.sendIr("dh_660hd", "KEY_LIST");
      else if (command.substr(5) == "DH660TIME-------") m_ir.sendIr("dh_660hd", "KEY_TIME");
      else if (command.substr(5) == "DH660K1---------") m_ir.sendIr("dh_660hd", "KEY_1   ");
      else if (command.substr(5) == "DH660K2---------") m_ir.sendIr("dh_660hd", "KEY_2   ");
      else if (command.substr(5) == "DH660K3---------") m_ir.sendIr("dh_660hd", "KEY_3   ");
      else if (command.substr(5) == "DH660K4---------") m_ir.sendIr("dh_660hd", "KEY_4   ");
      else if (command.substr(5) == "DH660K5---------") m_ir.sendIr("dh_660hd", "KEY_5   ");
      else if (command.substr(5) == "DH660K6---------") m_ir.sendIr("dh_660hd", "KEY_6   ");
      else if (command.substr(5) == "DH660K7---------") m_ir.sendIr("dh_660hd", "KEY_7   ");
      else if (command.substr(5) == "DH660K8---------") m_ir.sendIr("dh_660hd", "KEY_8   ");
      else if (command.substr(5) == "DH660K9---------") m_ir.sendIr("dh_660hd", "KEY_9   ");
      else if (command.substr(5) == "DH660K0---------") m_ir.sendIr("dh_660hd", "KEY_0   ");
      else if (command.substr(5) == "DH660CHANUP-----") m_ir.sendIr("dh_660hd", "KEY_CHANNELUP");
      else if (command.substr(5) == "DH660CHANDWN----") m_ir.sendIr("dh_660hd", "KEY_CHANNELDOWN       ");
      else if (command.substr(5) == "DH660INFO-------") m_ir.sendIr("dh_660hd", "KEY_INFO        ");
      else if (command.substr(5) == "DH660DIRECTORY--") m_ir.sendIr("dh_660hd", "KEY_DIRECTORY  ");
      else if (command.substr(5) == "DH660MENU-------") m_ir.sendIr("dh_660hd", "KEY_MENU       ");
      else if (command.substr(5) == "DH660EPG--------") m_ir.sendIr("dh_660hd", "KEY_VOLUMEDOWN ");
      else if (command.substr(5) == "DH660UP---------") m_ir.sendIr("dh_660hd", "KEY_UP     ");
      else if (command.substr(5) == "DH660EXIT-------") m_ir.sendIr("dh_660hd", "KEY_EXIT   ");
      else if (command.substr(5) == "DH660LEFT-------") m_ir.sendIr("dh_660hd", "KEY_LEFT   ");
      else if (command.substr(5) == "DH660SELECT-----") m_ir.sendIr("dh_660hd", "KEY_SELECT");
      else if (command.substr(5) == "DH660RIGHT------") m_ir.sendIr("dh_660hd", "KEY_RIGHT       ");
      else if (command.substr(5) == "DH660SUBTITLE---") m_ir.sendIr("dh_660hd", "KEY_SUBTITLE       ");
      else if (command.substr(5) == "DH660DOWN-------") m_ir.sendIr("dh_660hd", "KEY_DOWN       ");
      else if (command.substr(5) == "DH660TEXT-------") m_ir.sendIr("dh_660hd", "KEY_TEXT      ");
      else if (command.substr(5) == "DH660STOP-------") m_ir.sendIr("dh_660hd", "KEY_STOP     ");
      else if (command.substr(5) == "DH660PLAY-------") m_ir.sendIr("dh_660hd", "KEY_PLAY        ");
      else if (command.substr(5) == "DH660PAUSE------") m_ir.sendIr("dh_660hd", "KEY_PAUSE      ");
      else if (command.substr(5) == "DH660RECORD-----") m_ir.sendIr("dh_660hd", "KEY_RECORD     ");
      else if (command.substr(5) == "DH660RED--------") m_ir.sendIr("dh_660hd", "KEY_RED       ");
      else if (command.substr(5) == "DH660GREEN------") m_ir.sendIr("dh_660hd", "KEY_GREEN");
      else if (command.substr(5) == "DH660YELLOW-----") m_ir.sendIr("dh_660hd", "KEY_YELLOW");
      else if (command.substr(5) == "DH660BLUE-------") m_ir.sendIr("dh_660hd", "KEY_BLUE");
      else if (command.substr(5) == "DH660NEXT-------") m_ir.sendIr("dh_660hd", "KEY_NEXT");
      else if (command.substr(5) == "DH660PREVIOUS---") m_ir.sendIr("dh_660hd", "KEY_PREVIOUS");
      else if (command.substr(5) == "DH660AUDIO------") m_ir.sendIr("dh_660hd", "KEY_AUDIO");
      else if (command.substr(5) == "DH660ZOOM-------") m_ir.sendIr("dh_660hd", "KEY_ZOOM");
   }
   else
   {
      // Check if it is LCC
